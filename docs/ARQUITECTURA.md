...
Patrón inspirado en exelban/stats (proyecto de terceros con licencia permisiva;
la licencia de BtoStats es PolyForm Strict, ver LICENSE): cada métrica es un módulo con
